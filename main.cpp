...
void opUpdate(long long l, long long r, long long val) {
    ...
    // Paso 1: partir rango que contiene l
    ...
    // Paso 2: partir rango que contiene r
    {
    ...
    // Paso 3: eliminar rangos completamente dentro de [l, r]
    {
...
void opSum(long long l, long long r) {
    ...
    for (int i = 0; i < total; i++) {
        if (rangos[i].fin >= l && rangos[i].inicio <= r) {
            ...
            suma += rangos[i].valor * (hasta - desde + 1);
        }
    }
